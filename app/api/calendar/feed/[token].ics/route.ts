...
export async function GET(_request: Request, { params }: { params: Promise<{}> }) {
  ...
  if (!matchesToken(feedToken, token.replace(/\.ics$/, ""))) return new NextResponse("Not found", { status: 404 });
